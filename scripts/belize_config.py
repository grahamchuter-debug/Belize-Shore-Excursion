"""Belize Shore Excursion — World 2.0 site configuration."""
...
APEX_HOST = "belizeshoreexcursion.com"
SITE = "Belize Shore Excursion"
EMAIL = "hello@belizeshoreexcursion.com"
DATE = "2026-09-06"
FONTS = (
    "https://fonts.googleapis.com/css2?family=Literata:opsz,wght@7..72,500;7..72,600;7..72,700"
...
BEST_ALT = (
    "Belize Barrier Reef and Mayan ruins representing Belize "
...
SLUG_IMAGES = {
    "cave-tubing-and-zip-line-combo": (ZIP_IMG, ZIP_ALT),
    "belize-cave-tubing": (CAVE_IMG, CAVE_ALT),
    "turtle-snorkel-and-island-time": (SNORKEL_IMG, SNORKEL_ALT),
    "altun-ha-and-belize-city-overview": (ALTUN_HA_IMG, ALTUN_HA_ALT),
    "shark-ray-alley-and-caye-caulker-beach-break": (BEACH_IMG, BEACH_ALT),
    "lamanai-eco-adventure": (LAMANAI_IMG, LAMANAI_ALT),
    "kukumba-beach-and-city": (BEACH_IMG, BEACH_ALT),
    "barrier-reef-snorkel": (SNORKEL_IMG, SNORKEL_ALT),
    "xunantunich-and-cave-tubing": (RUINS_IMG, RUINS_ALT),
    "private-tubing-expedition": (PRIVATE_IMG, PRIVATE_ALT),
    "cave-tubing-and-jungle-trek-with-lunch": (CAVE_IMG, CAVE_ALT),
    "jungle-zip-line": (ZIP_IMG, ZIP_ALT),
    "belize-city-and-zoo-combo": (ZOO_IMG, ZOO_ALT),
    "belize-zoo-and-jeep-adventure": (JEEP_IMG, JEEP_ALT),
    "zip-line-and-belize-zoo-with-lunch": (ZIP_IMG, ZIP_ALT),
    "howler-monkey-sanctuary": (ZOO_IMG, ZOO_ALT),
    "baboon-sanctuary-and-jeep-adventure": (JEEP_IMG, JEEP_ALT),
    "expedition-to-crooked-tree-wildlife-sanctuary": (INTRO_IMG, INTRO_ALT),
    "jungle-jeep-adventure": (JEEP_IMG, JEEP_ALT),
    "jungle-jeep-adventure-and-beach-break": (BEACH_IMG, BEACH_ALT),
    "jungle-jeep-adventure-and-sibun-wildlife-river-cruise": (JEEP_IMG, JEEP_ALT),
    "belize-jungle-jeep-rum-factory-and-museum-tour": (PORT_IMG, PORT_ALT),
    "belize-city-and-rum-factory-tour": (PORT_ARRIVAL_IMG, PORT_ARRIVAL_ALT),
    "city-sightseeing-and-highlights": (PORT_IMG, PORT_ALT),
    "river-wallace-and-burrell-boom": (INTRO_IMG, INTRO_ALT),
    "beach-and-city": (BEACH_IMG, BEACH_ALT),
    "journey-to-cahal-pech": (RUINS_IMG, RUINS_ALT),
    "altun-ha-and-jeep-adventure": (ALTUN_HA_IMG, ALTUN_HA_ALT),
    "altun-ha-and-river-wallace": (ALTUN_HA_IMG, ALTUN_HA_ALT),
    "altun-ha-mayan-ruins-and-tropical-jungle-monkey-reserve": (ALTUN_HA_IMG, ALTUN_HA_ALT),
    "altun-ha-mayan-ruins-and-wildlife-of-the-belize-zoo": (ZOO_IMG, ZOO_ALT),
    "adventure-to-altun-ha": (ALTUN_HA_IMG, ALTUN_HA_ALT),
    "adventure-to-altun-ha-and-belize-zoo": (ALTUN_HA_IMG, ALTUN_HA_ALT),
    "belize-party-bus": (PORT_ARRIVAL_IMG, PORT_ARRIVAL_ALT),
}
